  ...
  def render(assigns) do
    ...
    <!-- 메인 게임 콘텐츠 -->
          <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="lg:col-span-2">
              <div class="bg-zinc-900 rounded-lg overflow-hidden mb-6 game-card">
    ...
    <!-- 상승/하락 예측 버튼 -->
                  <div class="grid grid-cols-2 gap-4">
                    <div class="border border-green-500 bg-zinc-800 rounded p-3 text-center cursor-pointer hover:bg-zinc-700 transition duration-200 game-card">
                      <div class="text-green-500 font-bold mb-1">상승 예측</div>
                      <div class="text-xs text-gray-400">현재 참여자 {@game.up_percent}%</div>
                    </div>
                    <div class="border border-red-500 bg-zinc-800 rounded p-3 text-center cursor-pointer hover:bg-zinc-700 transition duration-200 game-card">
    ...
    <!-- 하단 요약 정보 -->
              <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
                <%= for item <- @summary do %>
                  <div class="bg-zinc-900 rounded-lg p-4 text-center game-card">
    ...
    <!-- 예측 정보 및 베팅 섹션 -->
            <div class="lg:col-span-1">
              <div class="bg-zinc-900 rounded-lg p-6 mb-6 game-card">
                  ...
                  <div class="grid grid-cols-3 gap-2 mb-4">
                    <%= for option <- @investment_options do %>
                      <button
                        ...
                        class={"bg-zinc-800 rounded p-2 text-center hover:bg-zinc-700 transition duration-200 " <> if(option.selected, do: "border border-blue-500", else: "")}
                      >
    ...
    <!-- 배지 -->
                  <div class="grid grid-cols-3 gap-2 mb-6">
                    <%= for badge <- @badges do %>
                      <div class="bg-zinc-800 rounded p-2 text-center game-card">
