  ...
  def render(assigns) do
    ...
    <!-- 게임 통계 -->
                <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-4">
                  <div class="bg-zinc-800 p-4 rounded-lg game-card">
    ...
    <!-- 투자 금액 선택 -->
                <div class="mb-6">
                  ...
                  <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                    <%= for option <- @betting_options do %>
                      <div
                        class="bg-zinc-800 p-4 rounded-lg cursor-pointer hover:bg-zinc-700 transition duration-150 game-card"
                ...
                <div class="flex justify-between items-center border-t border-zinc-800 pt-4">
                  ...
                  <button
                    phx-click="join_game"
                    class="bg-yellow-400 text-black font-bold py-3 px-6 rounded hover:bg-yellow-500 transition duration-200"
                  >
                    참여하기
                  </button>
                </div>
    ...
    <!-- 상위 참가자 -->
              <div class="bg-zinc-900 rounded-lg p-6 game-card">
